 ...
 * </p>
 * <ul>
 *   <li>{@link duc.uscript.uScript.SymbolRef#getSymbol <em>Symbol</em>}</li>
 * </ul>
 *
 * @see duc.uscript.uScript.UScriptPackage#getSymbolRef()
 * @model
 * @generated
 */
public interface SymbolRef extends Expression
{
   ...
   * @see duc.uscript.uScript.UScriptPackage#getSymbolRef_Symbol()
   * @model
   * @generated
   */
  Symbol getSymbol();
  ...
  /**
   * Sets the value of the '{@link duc.uscript.uScript.SymbolRef#getSymbol <em>Symbol</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
