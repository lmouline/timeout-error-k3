 ...
 * </p>
 * <ul>
 *   <li>{@link duc.uscript.execution.impl.ArrayRefValueImpl#getInstance <em>Instance</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArrayRefValueImpl extends MinimalEObjectImpl.Container implements ArrayRefValue {
	/**
	...
	protected EClass eStaticClass() {
		return ExecutionPackage.Literals.ARRAY_REF_VALUE;
	}
		...
		if (instance != null && instance.eIsProxy()) {
			...
			if (instance != oldInstance) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ExecutionPackage.ARRAY_REF_VALUE__INSTANCE, oldInstance, instance));
			}
		}
		return instance;
	}
	...
	public void setInstance(ArrayInstance newInstance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExecutionPackage.ARRAY_REF_VALUE__INSTANCE, oldInstance, instance));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExecutionPackage.ARRAY_REF_VALUE__INSTANCE:
