 ...
 * </p>
 * <ul>
 *   <li>{@link duc.uscript.execution.impl.OutputStreamImpl#getStream <em>Stream</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OutputStreamImpl extends MinimalEObjectImpl.Container implements OutputStream {
	...
	protected EClass eStaticClass() {
		return ExecutionPackage.Literals.OUTPUT_STREAM;
	}
	...
	public EList<String> getStream() {
		if (stream == null) {
			stream = new EDataTypeEList<String>(String.class, this, ExecutionPackage.OUTPUT_STREAM__STREAM);
		}
		return stream;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExecutionPackage.OUTPUT_STREAM__STREAM:
				return getStream();
		}
