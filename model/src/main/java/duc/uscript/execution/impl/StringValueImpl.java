 ...
 * </p>
 * <ul>
 *   <li>{@link duc.uscript.execution.impl.StringValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringValueImpl extends MinimalEObjectImpl.Container implements StringValue {
	...
	protected EClass eStaticClass() {
		return ExecutionPackage.Literals.STRING_VALUE;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExecutionPackage.STRING_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExecutionPackage.STRING_VALUE__VALUE:
				return getValue();
		}
