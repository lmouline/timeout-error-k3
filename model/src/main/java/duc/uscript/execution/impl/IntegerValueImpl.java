 ...
 * </p>
 * <ul>
 *   <li>{@link duc.uscript.execution.impl.IntegerValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegerValueImpl extends MinimalEObjectImpl.Container implements IntegerValue {
	...
	protected EClass eStaticClass() {
		return ExecutionPackage.Literals.INTEGER_VALUE;
	}
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExecutionPackage.INTEGER_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExecutionPackage.INTEGER_VALUE__VALUE:
				return getValue();
		}
